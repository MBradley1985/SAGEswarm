...
def analyze_and_plot(tracks_dir, space_file, output_dir=None, csv_output_path=None):
    ...
    try:
        ...
        # Prepare param_matrix and param_names for GIF
        param_matrix = positions
        # param_names is already defined
        return {'param_matrix': param_matrix, 'param_names': param_names}, scores
